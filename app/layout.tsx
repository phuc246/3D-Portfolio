...
export const metadata: Metadata = {
  ...
  keywords: "Pin Lee, Frontend Engineer, React Developer, Three.js, Creative Developer, Web Development, Angular, JavaScript, TypeScript, Portfolio",
  authors: [{ name: "Pin Lee" }],
  creator: "Pin Lee",
  publisher: "Pin Lee",
  formatDetection: {
    email: false,
